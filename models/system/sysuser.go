...
type SysUserId struct {
	UserId int `gorm:"primary_key;AUTO_INCREMENT;column:id"  json:"id"` // 编码
}

type SysUserB struct {
	FullName string `gorm:"type:varchar(128)" json:"fullname"` // 昵称
	//Phone    string `gorm:"type:varchar(11)" json:"phone"`     // 手机号
	RoleId   int    `gorm:"type:int(11)" json:"role_id"`        // 角色编码
